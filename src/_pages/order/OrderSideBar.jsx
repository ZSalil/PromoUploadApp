...
const OrderSideBar = () => {
  const {selectedValues,handleChange,onSubmit } = React.useContext(OrderContext);
      ...
      <Stack spacing={2}>
        ...
        <FormControl>
          ...
          <RadioGroup
            ...
            name="electus"
            value={selectedValues?.electus?.value}
          ...
          >
            ...
            />
            <FormControlLabel value="male" control={<Radio />} label="Electus Nz (tbnz)" />
          </RadioGroup>
        </FormControl>
        <FormControl>
          <FormLabel id="demo-controlled-radio-buttons-group" className="fw-bold">
